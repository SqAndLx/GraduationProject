<template>
    <el-table :data="tableData.slice((currentPage-1)*13,currentPage*13)" border >
        ...
        <el-table-column prop="hymoney" label="会员价" width="230" align="center" v-if=true></el-table-column>
        <el-table-column prop="money" label="消费金额" width="230" align="center" v-else></el-table-column>
